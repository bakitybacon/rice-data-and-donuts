...
Now, onto a little bit of an exploration of how holidays effect Uber pickups.
...
We first fit an OLS model, just to give us an idea how the mean is changing over time.
...
The first section is commonly called the _train set_. The second is commonly called the _train set_.
...
So, daily and hourly seasonality are being handled as we would expect. Notice Friday and Saturday are very high! It also identifies a solid trend.
